...
public class Jam_2511533012 {
	...
	public Jam_2511533012(int h, int m, int s) {
	...
	public static Jam_2511533012 fromSeconds(int total) {
		if (total < 0) throw new IllegalArgumentException("detiki negatif");
		total %= 24 * 3600;
	...
	public int compareTo(Jam_2511533012 other) {
		return Integer.compare(this.toSeconds(), other.toSeconds());
	}
	public boolean equals(Object o) {
		if(!(o instanceof Jam_2511533012 j)) return false;
